...
https://github.com/coseyfannitutti/USBaspLoader/tree/atmega328p
  - Please ensure you are in the atmega328p branch of my fork of the USBaspLoader repository when downloading.
